--Este código é o criado por Leonardo Ono;
--Este arquivo deve ser apagado no futuro;
--Usar este arquivo como referência;
--Link video: https://www.youtube.com/watch?v=krw8q-eQ9E4
